...
const book1 = new Book("Libro 1", "Autor 1", false, "ISBN-1");
library.addBook(book1);
library.loadBook(book1, user1);

devolución tardía (agregando 10 días a la fecha de préstamo)
book1.borrowedDate.setDate(book1.borrowedDate.getDate() - 10);
